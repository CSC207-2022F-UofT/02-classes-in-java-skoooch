...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two String objects in as an argument and concatenates them to be this Silly instance's
     * name.
     *
     * @param str1 a number for this Silly instance's name.
     * @param str2 a number for this Silly instance's name.
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        int return_int = this.name.length() - other.name.length();
        return return_int;
    }
